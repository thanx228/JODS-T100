<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PCConfSOPopup.aspx.vb" Inherits="MIS_T100.PCConfSOPopup" %>
            ...
            <tr>
                <td align="left" 
                    ...
                    <asp:Label ID="Label1" runat="server" Font-Size="Medium" ForeColor="Blue" 
                        Text="Detail PC Confirm Date Sale Order"></asp:Label>
                </td>
            </tr>
        </table>
