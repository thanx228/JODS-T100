<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Styles/MIS.Master" CodeBehind="WorkStatus.aspx.vb" Inherits="MIS_T100.WorkStatus" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
           ...
           <asp:GridView ID="gvShow" runat="server" AutoGenerateColumns="False" Width="2200px"
...
<%--                    <asp:BoundField DataField="xmdc007" HeaderText="SO Qty" />
    ...
    <asp:GridView ID="gvShowPiVot" runat="server" AutoGenerateColumns="False" 
            ShowHeaderWhenEmpty="True" EmptyDataText="Not have Data Record" BackColor="#CCCCCC" BorderColor="#999999"
