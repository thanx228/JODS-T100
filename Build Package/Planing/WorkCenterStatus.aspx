<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Styles/MIS.Master" CodeBehind="WorkCenterStatus.aspx.vb" Inherits="MIS_T100.WorkCenterStatus" %>
            ...
            <table  style="width:75%;">
                <tr>
                    ...
                    <td class="style11" style="background-color: #FFFFFF">
                        <asp:TextBox ID="tbWC" runat="server" MaxLength="5" Width="50px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="background-color: #FFFFFF" class="style14">
...
<%--                   <asp:TemplateField HeaderText="No.">
                   ...
                   <%-- <asp:BoundField DataField="" HeaderText="Customer" />--%>
                    ...
                    <asp:BoundField DataField="imaal004" HeaderText="Specifaction" />
                     ...
                     <asp:BoundField DataField="sfca004" HeaderText="CompletedQty Qty" DataFormatString="{0:N3}" >
                     <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundField>
                     <asp:BoundField DataField="sfaa056" HeaderText="Scarp Qty" DataFormatString="{0:N3}" >
                     <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundField>
                    ...
                    <asp:BoundField DataField="sfcb027" HeaderText="StardardOutput"  DataFormatString="{0:N3}" >
                     <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundField>
                    ...
                    <asp:BoundField DataField="sfcb029" HeaderText="ReworkTrs-In" DataFormatString="{0:N3}"  />
                    <asp:BoundField DataField="sfcb034" HeaderText="TransferOutforRework" DataFormatString="{0:N3}"  >
                     <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundField>
