<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Styles/MIS.Master" CodeBehind="SaleUndeliveryStatusPeriod.aspx.vb" Inherits="MIS_T100.SaleUndeliveryStatusPeriod" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <link href="../Scripts/gridviewScroll.css" rel="stylesheet" />
        ...
        $(document).ready(function () {
            GvUndelPeriodScrollbar();

        });

        function GvUndelPeriodScrollbar() {
