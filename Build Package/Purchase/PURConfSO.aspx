<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Styles/MIS.Master" CodeBehind="PURConfSO.aspx.vb" Inherits="MIS_T100.PURConfSO" Debug = "true"   %>
...
<%--                                <asp:TextBox ID="tbDateFrom" runat="server" Width="80px"></asp:TextBox>
                    ...
                    <table style="width: 75%;" bgcolor="White">
                        ...
                        <tr>
                            <td class="style7">
                                Plan Batech No.</td>
                            <td class="style9">
                                <asp:Label ID="lbPlanBatch" runat="server"></asp:Label>
                            </td>
                            <td class="style25">
                                PC Confirm Date</td>
                            <td style="background-color: #FFFFFF">
                        ...
                        <tr>
                            <td class="style7">
                                Purchase Confirm Date</td>
                            <td class="style9">
                                <asp:TextBox ID="tbPURDate" runat="server" Width="80px"></asp:TextBox>
                                <asp:CalendarExtender ID="tbPURDate_CalendarExtender" runat="server" 
                                    Enabled="True" Format="dd/MM/yyyy" TargetControlID="tbPURDate">
                                </asp:CalendarExtender>
                            </td>
                            <td class="style25">
                                &nbsp;</td>
                        ...
                        <tr>
                            ...
                            <td class="style9" colspan="3">
                                <asp:TextBox ID="tbRemark" runat="server" BackColor="#FFFFCC" 
                    ...
                    <table style="width: 75%; background-image: url('../Images/btt.jpg');">
                        <tr>
                            <td align="center" 
                                ...
                                style="background-image: url('http://localhost:52038/Images/btt.jpg'); background-repeat: no-repeat" 
                                class="style26">
       ...
       <asp:GridView ID="gvShow" runat="server" AutoGenerateColumns="False" Width="3200"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Deatil SO Change">
                        <ItemTemplate>
                            <asp:HyperLink ID="hlSOChange" runat="server" Target="_blank">SO & Forecast Change </asp:HyperLink>
                        </ItemTemplate>
                    </asp:TemplateField>
