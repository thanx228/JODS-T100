 ...
 <asp:TabContainer ID="TabContainer1" runat="server" Height="100%"  Width="100%" 
     ...
     <asp:TabPanel ID="TabPanel1" runat="server" HeaderText="ADD DATA" Height="800">
        <ContentTemplate >
            ...
            <asp:Label ID="Label37" runat="server" CssClass="fontChar" Text="amount of rows"></asp:Label>&nbsp;<asp:Label ID="lbCountShow" runat="server" CssClass="fontChar" ForeColor="Blue"></asp:Label>
