            ...
            <table style="width: 75%;">
                <tr>
                    ...
                    <td bgcolor="White" class="style10">
                        <uc1:UsingMO_TypeGenBatch runat="server" ID="UsingMO_TypeGenBatch" />
                    </td>
            ...
            <table style="width:75%;">
                <tr>
                    <td align="center" 
                        ...
                        &nbsp;<asp:Button ID="btUpdate" runat="server" Text="Update PO/SO Seq" />
                    ...
                    <td style="vertical-align: top; background-color: #FFFFFF">
                        <asp:GridView ID="gvShow" runat="server" AutoGenerateColumns="False" 
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="MB022" HeaderText="Lot Control" />
                            </Columns>
                            <FooterStyle BackColor="#99CCCC" ForeColor="#003399" />
                            <HeaderStyle BackColor="#003399" Font-Bold="True" ForeColor="#CCCCFF" 
