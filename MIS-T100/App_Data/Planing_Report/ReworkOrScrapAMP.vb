...
Public Class ReworkOrScrapAMP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MIS_T100.ReworkOrScrapAMP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReworkOrScrapAMP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReworkOrScrapAMP = New ReworkOrScrapAMP()
        rpt.Site = Me.Site
        Return rpt
    End Function
