...
Public Class ShowCrystalReport
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        End If
        If File.Exists(Server.MapPath("~/App_Code/Print/" & folder & "/" & fileName)) Then
            Dim aa As String = "0"
        End If

        CrystalReportSource1.Report.FileName = Server.MapPath("~/App_Code/Print/" & folder & "/" & fileName)
        Select Case dbName
            Case "MIS"
            ...
            Case "MIST100"
                'ConfigCrystalReport.SubMIST100_CRCrystalLogon(CrystalReportSource1.ReportDocument)
            Case Else
                Exit Sub
        End Select
