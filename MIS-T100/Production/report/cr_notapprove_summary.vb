...
Public Class cr_notapprove_summary
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "cr_notapprove_summary.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MIS_T100.cr_notapprove_summary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcr_notapprove_summary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cr_notapprove_summary = New cr_notapprove_summary()
        rpt.Site = Me.Site
        Return rpt
    End Function
