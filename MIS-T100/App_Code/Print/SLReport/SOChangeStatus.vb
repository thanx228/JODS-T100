...
Public Class SOChangeStatus
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MIS_T100.SOChangeStatus.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSOChangeStatus
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SOChangeStatus = New SOChangeStatus()
        rpt.Site = Me.Site
        Return rpt
    End Function
