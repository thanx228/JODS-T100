Public Class SLUndelPeriodPopUp
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim StockQty As String = Request.QueryString("StockQty").ToString.Trim
    ...
    Private Sub ShowgvUndelivery(ByRef GridName As GridView, ByVal HasShow As Boolean, ByVal PageIndex As Integer)
        ...
        'ชื่อคอลัมน์หัวตาราง  
        Dim ShowFiled As String = "CustID,SalesOrderNo,Version,ComfirmedDate,DeliveryDate,OrderedQty,DeliveryQty,SampleQty,SampleDeliveryQty,BalanceQty,Unit,CustomerPO"
        'ตัด , ออก
        Dim ArrayShowFiled() As String = Split(ShowFiled, ",")
        'seting column
    ...
    Private Sub ShowGvMO(ByRef GridName As GridView, ByVal HasShow As Boolean, ByVal PageIndex As Integer)
        'ชื่อคอลัมน์หัวตาราง  
        Dim ShowFiled As String = "SalesOrderNo,Ver,MOOrderNo,ComfirmedDate,PlanCompletDate,ProductionQty,CompletedQty,ScarpQty,BalanceQty"
        'ตัด , ออก
        Dim ArrayShowFiled() As String = Split(ShowFiled, ",")
        'seting column
        Dim DtShow, dt1, dt2 As New Data.DataTable
        ...
        For e As Integer = 0 To dt1.Rows.Count - 1
            Dim ShowSalesOrder As String = "-", ShowVer As String = "-",
                ...
                ShowMOQty As String = "0", ShowCmpleQty As String = "0",
                ShowScarpQty As String = "0", ShowBalanceQtyMO As Integer = "0",
            ...
            If dt1.Rows.Count > 0 Then
                ...
                Dim Comma2 As Decimal = CDec(ShowCmpleQty)
                ShowCmpleQty = String.Format("{0:n0}", Comma2)
    ...
    Private Sub ShowGvPO(ByRef GridName As GridView, ByVal HasShow As Boolean, ByVal PageIndex As Integer)
        Dim tempTable As String = "TempSOUnDeliveryPeriod" & Session("UserName")
        'ชื่อคอลัมน์หัวตาราง  
        Dim ShowFiled As String = "SalesOrderNo,Version,POOrderNo,ComfirmedDate,DeliveryDate,PurchaseQty,RecelvedVolumeQty,BalanceQty"
        'ตัด , ออก
        Dim ArrayShowFiled() As String = Split(ShowFiled, ",")
        'seting column
        Dim DtShow, dt1, dt2 As New Data.DataTable
