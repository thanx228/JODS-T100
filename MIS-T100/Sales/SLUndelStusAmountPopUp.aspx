<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Styles/MIS.Master" CodeBehind="SLUndelStusAmountPopUp.aspx.vb" Inherits="MIS_T100.SLUndelStusAmountPopUp" %>
        ...
        <ContentTemplate>
                ...
                <tr>
                    ...
                    <asp:Label ID="Label18" runat="server" Font-Size="Medium" ForeColor="Blue" 
                        Text="Detail Sale Undelivery  Amount"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td align="center">
            ...
            <div style="width:100%; background-color :white;">     
                <asp:Label runat="server" Text="Stock List" Font-Size="Medium" ForeColor="OrangeRed" Font-Bold="True"></asp:Label>
