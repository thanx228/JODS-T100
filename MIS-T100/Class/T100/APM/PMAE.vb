...
Public Class PMAE
    ...
    '# Module : APM
    '# Table : pmae_t
    '# azmm200 : Customer Info : Tab Customer Label

    '# Function for select rows Top 100 (Example)
    '# select * from Table where field ='string' AND field2 ='string'
    Private Const strCustInfoTabCL_Rows100 As String = "select * from pmae_t  where rownum <= 100 "
    Shared Function CustInfoTabCL_Rows100() As String
        Return strCustInfoTabCL_Rows100
    End Function
