...
Public Class PMAC
    ...
    '# Module : APM
    '# Table : pmac_t
    '# azmm200 : Customer Info : Tab Partnership

    '# Function for select rows Top 100 (Example)
    '# select * from Table where field ='string' AND field2 ='string'
    Private Const strCustInfoTabPN_Rows100 As String = "select * from pmac_t  where rownum <= 100 "
    Shared Function CustInfoTabPN_Rows100() As String
        Return strCustInfoTabPN_Rows100
    End Function
