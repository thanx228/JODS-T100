...
Public Class PMAF
    ...
    '# Module : AOO
    '# Table : pmaf_t
    '# azmm200 : Customer Info : Tab Bank Info

    '# Function for select rows Top 100 (Example)
    '# select * from Table where field ='string' AND field2 ='string'
    Private Const strCustInfoTabBack_Rows100 As String = "select * from pmaf_t  where rownum <= 100 "
    Shared Function CustInfoTaBack_Rows100() As String
        Return strCustInfoTabBack_Rows100
    End Function
